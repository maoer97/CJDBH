function initCesium(){
	/**
	 * Created by duxiaohui on 2018/3/2.
	 */
	
	//var earth_base_url = "http://127.0.0.1:8080/";
	...
	*/
	...
	var initialPosition = new Cesium.Cartesian3.fromDegrees(107.29742,34.597944, 21348278.0);//位置
	var initialOrientation = new Cesium.HeadingPitchRoll.fromDegrees(7.1077496389876024807, -31.987223091598949054, 0.025883251314954971306);//朝向
	...
	// });
	// viewer.terrainProvider = terrainProviders;
	//
	// var terrainProviderse = Cesium.createWorldTerrain({
